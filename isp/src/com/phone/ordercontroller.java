...
public class ordercontroller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		System.out.println("name=" + n_m + "address=" + add_r + "ph=" + p_h
				+ "email=" + e_mail + "city=" + c_ity + "date=" + d_ate
				+ "mobile=" + p_nm + "price=" + c_nm);
		...
		try {
			...
			if (s > 0) {
				String sql = "insert into customer(name,address,ph,email,city,date,mobile,price) values ('"
						+ n_m
						+ "','"
						+ add_r
						+ "','"
						...
						+ "','"
						+ c_nm + "')";
				String sql1 = "update main SET stock= ('" + s
						+ "')  where pname=('" + pn + "')";
				...
				out.println("<h1 align='center'>" + "Logout Sucessfully..."
						+ "</h1>");
			}
