...
/**
 * Servlet implementation class blackberrycontroller
 */
public class blackberrycontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public blackberrycontroller() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String sql1 = "SELECT brand,pname,os,camera,stock,cost,size,colour,processor,memory,RAM FROM main where pname='"
					+ name + "'";
